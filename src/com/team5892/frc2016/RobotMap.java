...
public class RobotMap {
	...
	public static double kHangerLeftPivotFullRange = -90.0;
	public static double kHangerRightPivotFullRange = -147.541;
	public static double kHangerLeftPivotOffset = 90.0;
	public static double kHangerRightPivotOffset = 142.377;
	...
	public static int kIntakeBallThreshold = 1000;
